...
const Location = () => {
 ...
 setCount2(count2 + (pictures.length - 1))
    ...
    return (
        <div>
    <Header classdiv="background_location"
     img={pictures[count1]} 
...
<Dropdown setstate={() => setOpen1(!open1)} state={open1} title="Description" />
<Collapses title='Description' description={description} state={open1} />
        </div>
        <div className='dropdown_equipment'>
<Dropdown setstate={() => setOpen2(!open2)} state={open2} title="Equipements" />
